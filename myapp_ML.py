...
def predict_F(Age,Alpha2_Macroglobuline,Haptoglobine,Apolipoprotéine_A1, Bilirubine,Gamma_GT,ALAT,Sexe_Femme, Sexe_Homme):
    input=np.array([[Age,Alpha2_Macroglobuline,Haptoglobine,Apolipoprotéine_A1, Bilirubine,Gamma_GT,ALAT,Sexe_Femme, Sexe_Homme]]).astype(np.float64)
...
def predict_A(Age,Alpha2_Macroglobuline,Haptoglobine,Apolipoprotéine_A1, Bilirubine,Gamma_GT,ALAT,Sexe_Femme, Sexe_Homme):
    input=np.array([[Age,Alpha2_Macroglobuline,Haptoglobine,Apolipoprotéine_A1, Bilirubine,Gamma_GT,ALAT,Sexe_Femme, Sexe_Homme]]).astype(np.float64)
...
def main():
    ...
    Apolipoprotéine_A1 = st.text_input("Apolipoprotéine_A1",1.42)
    ...
    if st.button("Predict"):
        output_A=predict_A(Age,Alpha2_Macroglobuline,Haptoglobine,Apolipoprotéine_A1, Bilirubine,Gamma_GT,ALAT,Sexe_Femme, Sexe_Homme)
        st.success('Actitest value {}'.format(output_A))
        output_F=predict_F(Age,Alpha2_Macroglobuline,Haptoglobine,Apolipoprotéine_A1, Bilirubine,Gamma_GT,ALAT,Sexe_Femme, Sexe_Homme)
